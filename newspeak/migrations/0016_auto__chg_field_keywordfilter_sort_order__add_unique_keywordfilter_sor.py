...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KeywordFilter.sort_order'
        db.alter_column('newspeak_keywordfilter', 'sort_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(unique=True))
        # Adding unique constraint on 'KeywordFilter', fields ['sort_order']
        db.create_unique('newspeak_keywordfilter', ['sort_order'])


    def backwards(self, orm):
        # Removing unique constraint on 'KeywordFilter', fields ['sort_order']
        db.delete_unique('newspeak_keywordfilter', ['sort_order'])


        # Changing field 'KeywordFilter.sort_order'
        db.alter_column('newspeak_keywordfilter', 'sort_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        'newspeak.keywordfilter': {
            ...
            'sort_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '20', 'unique': 'True'})
        }
    }
