...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KeywordFilter.sort_order'
        db.add_column('newspeak_keywordfilter', 'sort_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KeywordFilter.sort_order'
        db.delete_column('newspeak_keywordfilter', 'sort_order')
