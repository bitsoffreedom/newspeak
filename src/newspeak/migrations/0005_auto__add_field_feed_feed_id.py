...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.feed_id'
        db.add_column('newspeak_feed', 'feed_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.feed_id'
        db.delete_column('newspeak_feed', 'feed_id')
    ...
    models = {
        'newspeak.feed': {
            ...
            'feed_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True'}),
