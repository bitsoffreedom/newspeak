...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('newspeak_feed', 'url', self.gf('django.db.models.fields.URLField')(max_length=330))

        # Changing field 'Feed.link'
        db.alter_column('newspeak_feed', 'link', self.gf('django.db.models.fields.URLField')(max_length=330))

    def backwards(self, orm):

        # Changing field 'FeedEnclosure.href'
        db.alter_column('newspeak_feedenclosure', 'href', self.gf('django.db.models.fields.URLField')(max_length=255))

        # Changing field 'Feed.url'
        db.alter_column('newspeak_feed', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Feed.link'
        db.alter_column('newspeak_feed', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'newspeak.feedenclosure': {
            ...
            'href': ('django.db.models.fields.URLField', [], {'max_length': '330'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
